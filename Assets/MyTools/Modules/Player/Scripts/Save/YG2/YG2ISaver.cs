...
namespace MyTools.PlayerSystem.Save
{
    public class YG2ISaver : ISaver
    {
        ...
        public void SaveActivitySkins(bool[] activitySkins) => YG2.saves.ActivitySkins = activitySkins;

        public int LoadNumberSelectedSkin() => YG2.saves.NumberSelectedSkin;
        public void SaveNumberSelectedSkin(int numberSelectedSkin) => YG2.saves.NumberSelectedSkin = numberSelectedSkin;

        public bool LoadMusicActive() => YG2.saves.MusicActive;
        public void SaveMusicActive(bool active) => YG2.saves.MusicActive = active;

        public bool LoadSoundsActive() => YG2.saves.SoundsActive;
        public void SaveSoundsActive(bool active) => YG2.saves.SoundsActive = active;

        public string LoadLanguage() => YG2.saves.Language;
        public void SaveLanguage(string language) => YG2.saves.Language = language;
